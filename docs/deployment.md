...
dedicated PostgreSQL database. Do not switch the production service or Caddy
route during staging acceptance. Production activation additionally requires
provider-side Hostinger token rotation confirmation, SMTP readiness, migration
and restore evidence, administrator MFA enrollment, and the cutover runbook.
